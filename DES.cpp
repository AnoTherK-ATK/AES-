...
#include "modes/DES-ECB.h"
#include "modes/DES-CBC.h"
#include "modes/DES-CFB.h"
#include "modes/DES-OFB.h"
#include "modes/DES-CTR.h"
...
SecByteBlock iv(DES::DEFAULT_KEYLENGTH);
int IOMode;
void randomKeyIV(){
